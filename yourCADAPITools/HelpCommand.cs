...
namespace yourCADAPITools
{
    ...
    internal sealed class HelpCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("cac46f6d-e9fe-4b23-b5e3-750797f189f5");
        ...
        {
            // Switch to the main thread - the call to AddCommand in HelpCommand's constructor requires
            // the UI thread.
